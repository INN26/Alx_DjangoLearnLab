...
urlpatterns = [
    ...
    path('books/update/', CustomBookUpdateView.as_view(), name='book-update'),  # Update a specific book
    path('books/delete/', CustomBookDeleteView.as_view(), name='book-delete'), # delete a specific book
